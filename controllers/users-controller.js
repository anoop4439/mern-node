...
const login = async (req, res, next) => {
    ...
    if(!existingUser) {
        const error = new HttpError('Invalid Credentials, try with correct ones', 403);
        return next(error);
    }
    ...
    try {
        ...
        const error = new HttpError('Could not log you in, please try with correct credentials', 500);
        return next(error);
    }
